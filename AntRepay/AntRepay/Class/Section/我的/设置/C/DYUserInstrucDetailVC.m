...
@interface DYUserInstrucDetailVC ()<UIWebViewDelegate>
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) DYGongGaoDetailView *detailView;
@property (nonatomic, assign) CGFloat height;
@end

@implementation DYUserInstrucDetailVC
...
-(void)dy_request{
    ...
    [DYAppReq GET:_url_yhXuZhi_detail param:params callBack:^(id responseObject, NSError *error) {
