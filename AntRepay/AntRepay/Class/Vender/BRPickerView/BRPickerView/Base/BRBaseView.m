...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = RGB_HEX(0xF1EDF6, 1.0f);
    }
    return _topView;
}
...
//        _rightBtn.layer.masksToBounds = YES;
        ...
        [_rightBtn setTitleColor:RGB_HEX(0x1f92d1, 1.0) forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = RGB_HEX(0x848484, 1.0);
